...
<section class="section section--gray section--mobile-white">
   ...
   <?
		$componentElementParams = array(
			...
			'PROPERTY_CODE' => ['BRAND'], //(isset($arParams['DETAIL_PROPERTY_CODE']) ? $arParams['DETAIL_PROPERTY_CODE'] : []),
    ...
    <?if($elementId){
      $arSelect = ["ID", "NAME",'IBLOCK_ID','IBLOCK_SECTION_ID','PROPERTY_BYE_WIDTH'];
      $arFilter = ["IBLOCK_ID"=>$arParams["IBLOCK_ID"],"ACTIVE"=>"Y",'=ID'=>$elementId];
...
<?/*<section class="similar-products">
    ...
    <?$APPLICATION->IncludeComponent(
        ...
        Array(
            "ACTION_VARIABLE" => "action",
            "ADDITIONAL_PICT_PROP_1" => "GALLERY",
            "ADD_PROPERTIES_TO_BASKET" => "Y",
            "BASKET_URL" => "/personal/basket.php",
            "CACHE_TIME" => "86400",
            "CACHE_TYPE" => "A",
...
<?if($SECTION['PROPERTIES']['BYE_WIDTH']['VALUE']){?>
    <section class="buy-with">
      <?$GLOBALS['recomendedFilter']['=ID'] = $SECTION['PROPERTIES']['BYE_WIDTH']['VALUE']?>
      <?$GLOBALS['recomendedFilter']['>CATALOG_PRICE_1'] = 0;?>
      <?$APPLICATION->IncludeComponent(
        "bitrix:catalog.section",
        "recomends_card",
        Array(
...
<section class="recently-viewed">
  <?$APPLICATION->IncludeComponent(
    ...
    Array(
      ...
      "IBLOCK_MODE" => "single",
      "IBLOCK_TYPE" => "catalog",
      "LABEL_PROP_1" => array("COLOR"),
      "LABEL_PROP_MOBILE_1" => array("COLOR"),
      "LABEL_PROP_POSITION" => "top-left",
      "MESS_BTN_ADD_TO_BASKET" => "В корзину",
      "MESS_BTN_BUY" => "Купить",
      "MESS_BTN_DETAIL" => "Подробнее",
