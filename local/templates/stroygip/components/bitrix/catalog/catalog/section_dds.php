 ...
 */
if(! $arCurSection['ID'])  $arCurSection['ID'] = $arResult["VARIABLES"]['SECTION_ID'];
$arFilter = ["IBLOCK_ID"=>$arParams["IBLOCK_ID"],"ACTIVE"=>"Y",'=SECTION_ID'=>$arCurSection['ID'],'INCLUDE_SUBSECTIONS'=>'Y'];
$cntElems = CIBlockElement::GetList([], $arFilter, [], false, false);
