            ...
            if ($arResult["bDescPageNumbering"] === true):
                ...
                do {
					...
					elseif ($arResult["nStartPage"] == $arResult["NavPageCount"] && $arResult["bSavePage"] == false):
                        ?>
						<a class="pagination__button" href="<?= $arResult["sUrlPath"] ?><?= $strNavQueryStringFull ?>"
                ...
                if ($arResult["NavPageNomer"] > 1):
					...
					<a class="pagination__next"
					   href="<?= $arResult["sUrlPath"] ?>?<?= $strNavQueryString ?>PAGEN_<?= $arResult["NavNum"] ?>=<?= ($arResult["NavPageNomer"] - 1) ?>">Вперед
						<div class="pagination__icon pagination__icon-next"></div>
					</a>
