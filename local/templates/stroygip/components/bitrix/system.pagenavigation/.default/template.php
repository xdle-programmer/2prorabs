...
?>
        ...
        <?$viewed = $arResult['NavPageSize']*$arResult['NavPageNomer']>$arResult['NavRecordCount']?$arResult['NavRecordCount']:$arResult['NavPageSize']*$arResult['NavPageNomer'];?>
        <div class="pagination__info">Вы посмотрели <?=number_format(intval($viewed),'0','',' ')?> товаров из <?=number_format(intval($arResult['NavRecordCount']),'0','',' ')?></div>
</div>
</div>
