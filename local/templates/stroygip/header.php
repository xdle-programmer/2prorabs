...
<head>
    ...
    <?
	//"/order/confirm_order/"
	$arr_ntu = array("/", "/basket/", "/order/", "/order/payment/", "/order/confirm_order/", "/personal/orders/", "/personal/credentials/", "/personal/viewed/", "/personal/estimates/");
	$arr_ntu_clear = array("/basket/", "/order/", "/order/payment/", "/order/confirm_order/");
	$arr_ntu_lk = array("/personal/orders/", "/personal/credentials/", "/personal/viewed/", "/personal/estimates/");
